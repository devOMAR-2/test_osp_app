...
Future<Uint8List> generateResume(format, ResumeModel resume) async {
  ...
  await buildPdfTemplate1(doc, ttfRegular, ttfBold, ttfLight, resume);
  await buildPdfTemplate2(doc, ttfRegular, ttfBold, ttfLight, resume);
  await buildPdfTemplate3(doc, ttfRegular, ttfBold, ttfLight, resume);
  await buildPdfTemplate4(doc, ttfRegular, ttfBold, ttfLight, resume);
  return doc.save();
}
